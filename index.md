...
Easy Kanban is a minimal, self-hosted personal task board designed to keep projects, tasks, and subtasks in one clear place. Built to avoid clutter, it features real-time cloud sync powered by a personal Neon database, board data conflict protection, JSON backup/restore, custom themes, and a private deployment gateway.

→ [View project on GitHub](https://github.com/barqx/easy-kanban){:target="_blank"}  
→ [Deployment instructions](https://github.com/barqx/easy-kanban#make-your-own-copy){:target="_blank"}
